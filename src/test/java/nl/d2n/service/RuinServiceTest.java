...
public class RuinServiceTest extends SpringContextTestCase {
    ...
    public void cityDoesNotExist() {
        try {
            ruinService.getRuin(new UserKey("cafebabe"), 42L, 1, 1);
    ...
    public void newRuinZoneDoesNotExist() throws ApplicationException {
        Ruin ruin = ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 1);
    ...
    public void addRoomInNonExistingZone() throws ApplicationException {
        try {
            ruinService.addRoom(new UserKey("cafebabe"), 43L, 13, 13, 1, 0);
        } catch (ApplicationException err) {
    ...
    public void addRoomAgain() throws ApplicationException {
        ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        ruinService.addRoom(new UserKey("cafebabe"), 43L, 1, 0, 1, 0);
        try {
            ruinService.addRoom(new UserKey("cafebabe"), 43L, 1, 0, 1, 0);
        } catch (ApplicationException err) {
    ...
    public void deleteEntrance() throws ApplicationException {
        ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        try {
            ruinService.deleteRoom(new UserKey("cafebabe"), 43L, 1, 0, 0, 0);
        } catch (ApplicationException err) {
    ...
    public void deleteRoom() throws ApplicationException {
        ruinService.getRuin   (new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        ruinService.addRoom   (new UserKey("cafebabe"), 43L, 1, 0, 1, 0);
        ruinService.deleteRoom(new UserKey("cafebabe"), 43L, 1, 0, 1, 0);
        assertNull(ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0).getRoom(1, 0));
    }
    ...
    public void deleteRoomWithDependentRooms() throws ApplicationException {
        ...
        ruinService.getRuin   (new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        ruinService.addRoom(new UserKey("cafebabe"), 43L, 1, 0, 1, 0);
        ruinService.addRoom   (new UserKey("cafebabe"), 43L, 1, 0, 2, 0);
        try {
            ruinService.deleteRoom(new UserKey("cafebabe"), 43L, 1, 0, 1, 0);
        } catch (ApplicationException err) {
            assertEquals(D2NErrorCode.ROOM_MAY_NOT_BE_DELETED, err.getError());
    ...
    public void addCorridor() throws ApplicationException {
        ruinService.getRuin(            new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        ruinService.addCorridor(        new UserKey("cafebabe"), 43L, 1, 0, 0, 0, RuinDirection.EAST);
        Room room = ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0).getRoom(0, 0);
    ...
    public void deleteCorridorThatHasAdjoiningRoom() throws ApplicationException {
        ...
        ruinService.addRoom(new UserKey("cafebabe"), 43L, 1, 0, 1, 0);
        try {
            ruinService.deleteCorridor(new UserKey("cafebabe"), 43L, 1, 0, 0, 0, RuinDirection.EAST);
        } catch (ApplicationException err) {
    ...
    public void deleteCorridor() throws ApplicationException {
        ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        ruinService.addCorridor(new UserKey("cafebabe"), 43L, 1, 0, 0, 0, RuinDirection.SOUTH);
        ruinService.deleteCorridor(new UserKey("cafebabe"), 43L, 1, 0, 0, 0, RuinDirection.SOUTH);
        Room room = ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0).getRoom(0, 0);
    ...
    public void setDoor() throws ApplicationException {
        ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        ruinService.addRoom(new UserKey("cafebabe"), 43L, 1, 0, 1, 0);
        ruinService.setDoor(new UserKey("cafebabe"), 43L, 1, 0, 1, 0, Door.LOCKED);
        Room room = ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0).getRoom(1, 0);
    ...
    public void setDoorInEntrance() throws ApplicationException {
        ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        try {
            ruinService.setDoor(new UserKey("cafebabe"), 43L, 1, 0, 0, 0, Door.LOCKED);
    ...
    public void setKey() throws ApplicationException {
        ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        ruinService.setKey(new UserKey("cafebabe"), 43L, 1, 0, 0, 0, Key.MAGNETIC_KEY);
        Room room = ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0).getRoom(0, 0);
    ...
    public void setZombies() throws ApplicationException {
        ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        ruinService.setZombies(new UserKey("cafebabe"), 43L, 1, 0, 0, 0, 3);
        Room room = ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0).getRoom(0, 0);
    ...
    public void addCorridorInNonExistingRoom() throws ApplicationException {
        ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        try {
            ruinService.addCorridor(new UserKey("cafebabe"), 43L, 1, 0, 42, 42, RuinDirection.NORTH);
        } catch (ApplicationException err) {
    ...
    public void changeInNonExistingRoom() throws ApplicationException {
        ruinService.getRuin(new UserKey("cafebabe"), 43L, 1, 0); // this generates the entrance
        try {
            ruinService.setZombies(new UserKey("cafebabe"), 43L, 1, 0, 42, 42, 3);
        } catch (ApplicationException err) {
            assertEquals(D2NErrorCode.ROOM_DOES_NOT_EXIST, err.getError());
        }
    }
