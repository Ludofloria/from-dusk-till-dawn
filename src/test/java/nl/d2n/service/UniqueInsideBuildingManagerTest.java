...
public class UniqueInsideBuildingManagerTest extends SpringContextTestCase {
    ...
    public void mergeWithList() {
        ...
        buildings.add(new InsideBuilding(1042L, "Upgraded Mapp",     false, 1050L, "item_electro", "Lorem ipsum", null, false, null, null, null)); // Change the name, keep the URL
        buildings.add(new InsideBuilding(1050L, "Watchtower",        false, 0L, "item_tagger", "Flavored text", null, false, null, null, null));
        buildings.add(new InsideBuilding(1033L, "Workshop",          true,  0L, "small_refine", "Lorem ipsum", null, false, null, null, null));
        buildings.add(new InsideBuilding(1075L, "Building Registry", true, 1033L, "item_rp_book2", "Lorem ipsum", null, false, null, null, null));
        manager.checkForExistence(buildings);
        assertEquals(5, manager.getMap().size());

        assertUniqueInsideBuilding(manager.get(1042L), 1042L, "Upgraded Mapp", false, 1050L, "item_electro", "Lorem ipsum");
        assertEquals("http://somewiki.com/upgraded_map", manager.get(1042L).getUrl());
        assertUniqueInsideBuilding(manager.get(1050L), 1050L, "Watchtower", false, null, "item_tagger", "Flavored text");
        assertUniqueInsideBuilding(manager.get(1033L), 1033L, "Workshop", true, null, "small_refine", "Lorem ipsum");
        assertUniqueInsideBuilding(manager.get(1075L), 1075L, "Building Registry", true, 1033L, "item_rp_book2", "Lorem ipsum");
        assertUniqueInsideBuilding(manager.get(1062L), 1062L, "Portal Lock", true, null, "small_door_closed", "Lorem ipsum");
        assertEquals(5, uniqueInsideBuildingDao.findUniqueInsideBuildings().size());
    }

    protected void assertUniqueInsideBuilding(UniqueInsideBuilding building, Long id, String name, boolean temporary,
                                              Long parent, String image, String flavor) {
