...
public class ProfileServiceTest extends SpringContextTestCase {
    ...
    public void testReadSoul() throws ApplicationException {
        User user = classCreator.createUser("BerZerg", new UserKey("CAFEBABE"), 11L, true, false, false, null);
        profileService.updateProfile(user);
        List<Distinction> distinctions = profileService.getDistinctions(1984L, UserCitizenConverter.convertUserToCitizen(user)).get(11);
    ...
    public void testSetSoulAndUpdate() throws ApplicationException {
        ...
        distinctions = profileService.getDistinctions(1984L, UserCitizenConverter.convertUserToCitizen(user)).get(11);
