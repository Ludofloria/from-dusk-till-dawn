...
public class BuildingActionTest extends SpringContextTestCase {
    ...
    public void createCity() {
        classCreator.createCity(12345L, "Temple of the Tedious");
    }
    ...
    public void cityDoesNotExist() {
        try {
            applicationContext.getBean(BuildingActionUnlock.class).execute(new UserKey("cafebabe"), 666L, 1040L, 1);
    ...
    public void buildingDoesNotExist() {
        try {
            applicationContext.getBean(BuildingActionUnlock.class).execute(new UserKey("cafebabe"), 12345L, 1666L, 1);
    ...
    public void unlockBuilding() throws ApplicationException {
        applicationContext.getBean(BuildingActionUnlock.class).execute(new UserKey("cafebabe"), 12345L, 1042L, 1);
        City city = cityDao.findCity(12345L);
        List<InsideBuilding> buildings = insideBuildingDao.findInsideBuildings(12345L);
    ...
    public void lockBuilding() throws ApplicationException {
        unlockBuilding();
        applicationContext.getBean(BuildingActionLock.class).execute(new UserKey("cafebabe"), 12345L, 1042L, 1);
        City city = cityDao.findCity(12345L);
        assertEquals(0, insideBuildingDao.findInsideBuildings(12345L).size());
    }

    @Test
    public void multipleBuildingActions() throws ApplicationException {
        applicationContext.getBean(BuildingActionUnlock.class).execute(new UserKey("cafebabe"), 12345L, 1042L, 1);
        applicationContext.getBean(BuildingActionUnlock.class).execute(new UserKey("cafebabe"), 12345L, 1050L, 1);
        applicationContext.getBean(BuildingActionLock.class).execute(  new UserKey("cafebabe"), 12345L, 1050L, 1);
        applicationContext.getBean(BuildingActionUnlock.class).execute(new UserKey("cafebabe"), 12345L, 1062L, 1);
        City city = cityDao.findCity(12345L);
        List<InsideBuilding> buildings = insideBuildingDao.findInsideBuildings(12345L);
