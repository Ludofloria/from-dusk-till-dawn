...
public class UserServiceTest extends SpringContextTestCase {
    ...
    public void updateUserName() throws ApplicationException {
        ...
        userService.updateUser(null, new UserKey("cafebabe"), 1984L, "Charlie", SECURE, NOT_SHUNNED, new ArrayList<Citizen>());
    ...
    public void updateUserDoesNotExist() throws ApplicationException {
        userService.updateUser(null, new UserKey("cafebabe"), 1984L, "Bob", SECURE, NOT_SHUNNED, new ArrayList<Citizen>());
        User user = userDao.find(new UserKey("cafebabe"));
    ...
    public void updateInsecureUser() throws ApplicationException {
        ...
        userService.updateUser(null, user.getKey(), 1984L, user.getName(), NOT_SECURE, NOT_SHUNNED, new ArrayList<Citizen>());
    ...
    public void updateShunnedUser() throws ApplicationException {
        User user = classCreator.createUser("Bob", new UserKey("cafebabe"), SECURE, NOT_SHUNNED, NOT_BANNED);
        userService.updateUser(null, user.getKey(), 1984L, user.getName(), SECURE, SHUNNED, new ArrayList<Citizen>());
        user = userDao.find(user.getKey());
    ...
    public void userChangedKeys() throws ApplicationException {
        User user = classCreator.createUser("Bob", new UserKey("cafebabe"), 11L, SECURE, NOT_SHUNNED, NOT_BANNED, null);
        userService.updateUser(null, new UserKey(user.getKey()+"_NOT_THE_SAME_KEY"), 1984L, user.getName(), SECURE, SHUNNED, new ArrayList<Citizen>());
        assertEquals(user.getId(), userDao.findByGameId(11L).getId());
    }
    ...
    public void updateUnshunnedUser() throws ApplicationException {
        User user = classCreator.createUser("Bob", new UserKey("cafebabe"), SECURE, NOT_SHUNNED, NOT_BANNED);
        userService.updateUser(null, user.getKey(), 1984L, user.getName(), SECURE, SHUNNED, new ArrayList<Citizen>());
        userService.updateUser(null, user.getKey(), 1984L, user.getName(), SECURE, NOT_SHUNNED, new ArrayList<Citizen>());
        user = userDao.find(user.getKey());
    ...
    public void updateCity() throws ApplicationException {
        User user = classCreator.createUser("Bob", new UserKey("cafebabe"), SECURE, NOT_SHUNNED, NOT_BANNED);
        userService.updateUser(classCreator.createCity(1333L, "City 1"), user.getKey(), 1984L, user.getName(), SECURE, NOT_SHUNNED, new ArrayList<Citizen>());
        userService.updateUser(classCreator.createCity(1666L, "City 2"), user.getKey(), 1984L, user.getName(), SECURE, NOT_SHUNNED, new ArrayList<Citizen>());
        assertEquals(true, userDao.isUserInCity(user.getId(), 1666L));
    }

    @Test
    public void removeDeadCitizensFromTown() throws ApplicationException {
        City city = classCreator.createCity(111, "City 1");
        User user1 = classCreator.createUser("User 1", new UserKey("ABCDEF"), 11L, true, false, false, city);
        User user2 = classCreator.createUser("User 2", new UserKey("GHIJKL"), 22L, true, false, false, city);
        User user3 = classCreator.createUser("User 3", new UserKey("MNOPQR"), 33L, true, false, false, city);
        User user4 = classCreator.createUser("User 4", new UserKey("STUVWX"), 44L, true, false, false, city);
        User user5 = classCreator.createUser("User 5", new UserKey("YZABCD"), 55L, true, false, false, classCreator.createCity(222, "City 2"));
    ...
    public void updateMultipleProfiles() throws ApplicationException {
        ...
        User user1 = classCreator.createUser("User 1", new UserKey("ABCDEF"), 11L, true, false, false, classCreator.createCity(111, "City 1"));
        User user2 = classCreator.createUser("User 2", new UserKey("GHIJKL"), 22L, true, false, false, newCity);
        User user3 = classCreator.createUser("User 3", new UserKey("MNOPQR"), 33L, true, false, false, classCreator.createCity(333, "City 3"));
        User user4 = classCreator.createUser("User 4", new UserKey("STUVWX"), 44L, true, false, false, null);
        ...
        userService.updateUser(newCity, new UserKey("MNOPQR"), 1984L, null, true, false, citizens);
        assertEquals(3, namesOfUpdatedUsers.size());
        assertEquals("User 3", namesOfUpdatedUsers.get(0));
        assertTrue("Active user should have been registered to new town", userDao.isUserInCity(user3.getId(), 444L)); // Active user
        assertTrue("Bulk updated user should have been registered to new town", userDao.isUserInCity(user1.getId(), 444L)); // Bulk updated user
        assertTrue("Bulk updated user should have been registered to new town", userDao.isUserInCity(user4.getId(), 444L)); // Bulk updated user
    }
}
