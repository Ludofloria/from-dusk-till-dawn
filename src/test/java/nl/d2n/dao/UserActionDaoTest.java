...
public class UserActionDaoTest extends SpringContextTestCase {
    ...
    public void getUserIds() {
        classCreator.createUser("Ap",    new UserKey("cafebabe"), 11L);
        classCreator.createUser("Bert",  new UserKey("cafebabe"), 22L);
        classCreator.createUser("Corne", new UserKey("cafebabe"), 33L);
        List<Citizen> citizens = new ArrayList<Citizen>();
        citizens.add(CitizenBuilder.createCitizen("Bert",  22L));
        citizens.add(CitizenBuilder.createCitizen("Corne", 33L));
