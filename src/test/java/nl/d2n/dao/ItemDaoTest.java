...
public class ItemDaoTest extends SpringContextTestCase {
    ...
    public void saveItem() {
        City city = createCity(13449L, "Cliffe of Tricks");
        ...
        zone = zoneDao.findZone(13449L, -10, 5);
        ...
        assertEquals(117L, fetchedItem.getD2nItemId().longValue());
    ...
    protected Item createItem(Zone zone, String name, String image, Integer amount, boolean broken, long d2nItemId, ItemCategory category) {
        Item item = new Item();
        item.setZone(zone);
        item.setName(name);
        item.setImage(image);
