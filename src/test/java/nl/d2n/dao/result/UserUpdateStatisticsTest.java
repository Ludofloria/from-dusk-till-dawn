...
public class UserUpdateStatisticsTest {
    ...
    public void getRating() {
        ...
        UserUpdateStatistics statistics = createStatistics(1234L, gameClock.getHoursAgo(7), 1, 7, 3, 15);
    ...
    protected UserUpdateStatistics createStatistics(Long id, Date lastUpdated, int recentReads, int recentWrites, int veryRecentReads, int veryRecentWrites) {
        UserUpdateStatistics statistics = new UserUpdateStatistics();
        if (lastUpdated != null) {
    ...
    protected UserUpdateCount createUserUpdateCount(Long id, int reads, int writes) {
