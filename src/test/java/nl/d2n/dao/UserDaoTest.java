...
public class UserDaoTest extends SpringContextTestCase {
    ...
    public void findByName() {
        classCreator.createUser("Alpha", new UserKey("cafebabe"), 11L);
        assertNotNull(userDao.findByGameId(11L));
    }
    ...
    public void testFindCityOfUserNoCityExists() {
        ...
        assertEquals(false, userDao.isUserInCity(user.getId(), 13499L));
    }
    ...
    public void findDeadUsersInTown() {
        ...
        List<User> users = userDao.findDeadUsersInTown(111L, aliveCitizens);
    ...
    public void testFindUsersNotYetRegisteredToSameTown() {
        ...
        User user2 = classCreator.createUser("User 2", new UserKey("GHIJKL"), 22L, true, false, false, classCreator.createCity(222, "City 2"));
        ...
        List<User> users = userDao.findUsersNotYetRegisteredToSameTown(111L, citizens);
    ...
    public void testFindUsersInCity() {
        ...
        assertEquals(3, userDao.findUsersInCity(111L).size());
    }
