...
public class ClassCreator {
    ...
    public UniqueInsideBuilding createUniqueInsideBuilding(
                Long buildingId, String name, boolean temporary, Long parent, String image,
    ...
    public City createCity(long id, String name) {
    ...
    public User createUser(String name, UserKey key, Long id) {
    ...
    public User createUser(String name, UserKey key, Long id, boolean secure, boolean shunned, boolean banned, City city) {
        User user = new User();
        user.setName(name);
        user.setKey(key);
        user.setGameId(id);
    ...
    public Zone createZone(City city, Integer x, Integer y) {
    ...
    public void createInsideBuilding(City city, Long buildingId, InsideBuildingStatus status) {
    ...
    public Distinction createDistinction(User user, String name, int amount) {
        ...
        distinction.setUniqueDistinctionId(1L);
