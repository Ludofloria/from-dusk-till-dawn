...
public class UniqueInsideBuildingTest {
    ...
    public void overwrite() throws JAXBException {
        ...
        UniqueInsideBuilding uniqueBuilding = new UniqueInsideBuilding(1042L, "Upgraded Map", true, 1050L, "item_electro", "Lorem ipsum", null, false, false);
        ...
        assertEquals(1042L, uniqueBuilding.getId().longValue());
    ...
    public void roundRobin() {
        ...
        assertEquals("Upgraded Map", uniqueBuilding.getName());
        assertEquals(true, uniqueBuilding.isTemporary());
        assertEquals(1050L, uniqueBuilding.getParent().longValue());
        assertEquals("item_electro", uniqueBuilding.getImage());
    ...
    public void differentImage() {
        UniqueInsideBuilding uniqueBuilding = new UniqueInsideBuilding(1042L, "Upgraded Map", true, 1050L, "item_electro", "Lorem ipsum", null, true, false);
        InsideBuilding building = new InsideBuilding(1042L, "Upgraded Map", true, 1050L, "item_bavario", "Lorem ipsum", null, true, null, null, null);
    ...
    public void sameImage() {
        UniqueInsideBuilding uniqueBuilding = new UniqueInsideBuilding(1042L, "Upgraded Map", true, 1050L, "item_electro", "Lorem ipsum", null, true, false);
        InsideBuilding building             = new InsideBuilding(1042L, "Upgraded Map Tool", true, 1050L, "item_electro", "Lorem ipsum", null, true, null, null, null);
        uniqueBuilding = UniqueInsideBuilding.createFromInsideBuilding(building, uniqueBuilding);
    ...
    @Test
    public void keepUrl() {
        UniqueInsideBuilding uniqueBuilding = new UniqueInsideBuilding(1042L, "Upgraded Map", true, 1050L, "item_electro", "Lorem ipsum", "http://somewiki.org", true, false);
        InsideBuilding building = new InsideBuilding(1042L, "Upgraded Map Tool", true, 1050L, "item_electro", "Lorem ipsum", null, true, null, null, null);
        uniqueBuilding = UniqueInsideBuilding.createFromInsideBuilding(building, uniqueBuilding);
