...
public class ItemTest {
    ...
    public void constructorTest() {
        ...
        assertEquals(117L, item.getD2nItemId().longValue());
    ...
    public void unmarshallXmlSnippet() throws JAXBException {
        ...
        assertEquals(104L, item.getD2nItemId().longValue());
    ...
    public void translateItemKey() {
        ...
        assertEquals(139L, item.getD2nItemId().longValue());
        assertEquals(true, item.isBroken());
