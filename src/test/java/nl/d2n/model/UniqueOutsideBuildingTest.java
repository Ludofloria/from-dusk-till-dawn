...
public class UniqueOutsideBuildingTest {
    ...
    public void constructor() {
        UniqueOutsideBuilding building = new UniqueOutsideBuilding(44L, "Garden Shed", "Lorem ipsum", null);
        building.setUrl("http://somewiki/garden_shed");
        assertEquals((Long)44L, building.getId());
    ...
    public void overwrite() throws JAXBException {
        ...
        UniqueOutsideBuilding uniqueBuilding = new UniqueOutsideBuilding(44L, "Garden Shed", "Lorem ipsum set iquor", null);
    ...
    @Test
    public void keepUrl() {
        UniqueOutsideBuilding uniqueBuilding = new UniqueOutsideBuilding(44L, "Garden Shed", "Lorem ipsum", "http://somewiki");
        OutsideBuilding building = new OutsideBuilding(44L, "Garden Shed", "Lorem ipsum", null);
        uniqueBuilding = UniqueOutsideBuilding.createFromOutsideBuilding(building, uniqueBuilding);
