...
public class WikiConstructionDataParserTest extends SpringContextTestCase {
    ...
    public void readFromFile() throws IOException, WikiConstructionParserException {
        ...
        WikiConstructionData construction = parser.parse(WikiConstructionLoadType.FROM_WIKI, 1010L, "http://die2nitewiki.com/wiki/Data:Wall_Upgrade_v1");
        assertConstructionData(construction,
                1010L, 10, "Wall Upgrade v1", 30,
                new String[] { "Twisted Plank", "Wrought Iron" },
                new Integer[] { 6, 4 } );
    ...
    protected void assertConstructionData(WikiConstructionData construction, Long id, Integer defence, String name, Integer ap, String[] names, Integer[] amounts) {
